...
console.log(`taks 1b1`,  createMenuItem(`ramen`, 9, `lunch`));
console.log(`task 1b2`, createMenuItem (`Pumpkin Pancakes`, 7, 'Breakfast'));
console.log(`task 1b3`, createMenuItem (`Biscuits and Gravy`, 5, `Breakfast`));
...
console.log(`task 5:`, addReview(reviews,`Billy`, 2, `Lame!`));
